...
enum opt_code
{
  ...
  OPT_mglibc = 1282,                         /* -mglibc */
  OPT_mmusl = 1283,                          /* -mmusl */
  OPT_mplt = 1284,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1285,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1286,                         /* -mrelax */
  OPT_mriscv_attribute = 1287,               /* -mriscv-attribute */
  OPT_msave_restore = 1288,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1289,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1290,                  /* -mstrict-align */
  OPT_mtune_ = 1291,                         /* -mtune= */
  OPT_muclibc = 1292,                        /* -muclibc */
  OPT_n = 1293,                              /* -n */
